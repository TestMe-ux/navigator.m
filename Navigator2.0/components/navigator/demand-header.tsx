          ...
          <div className="flex items-center gap-2">
            ...
            <Tooltip>
              ...
              <TooltipContent side="top" className="max-w-sm bg-slate-800 text-white border-slate-700">
                <p className="text-sm">
                  Comprehensive analysis of market demand patterns, competitor pricing strategies, and forecasting models to optimize revenue management and pricing decisions for {propertyCity}.
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
          <p className="text-sm text-muted-foreground">
            Market demand insights with competitive intelligence and forecasting for {propertyCity}
          </p>
        </div>
