        ...
        <div className="space-y-2 mt-1">
          {payload.map((entry: any, index: number) => {
            ...
            const getVarianceText = (dataKey: string) => {
              const variance = data?.[`${dataKey}ChangeInRank`]
            ...
            return (
              <div key={index} className={`flex justify-between items-center py-1.5 pl-2 pr-4 rounded-md ${isMyHotel ? 'bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700' : ''
                }`}>
                {/* Property Column */}
