 ...
 * Help Tab Component
 * 
 * Tab navigation for help page with:
 * - 4 help tabs with icons
 * - Responsive design
 * - Clean styling matching Settings page
 * 
 * @component
 * @version 1.0.0
 */
export function HelpTab({ className, activeTab, setActiveTab, helpTabs }: HelpTabProps) {
  return (
