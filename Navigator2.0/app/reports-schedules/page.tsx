...
import { getScheduleReportData } from "@/lib/reports"
...
export default function ScheduledReportsPage() {
  ...
  const handleEditSchedule = (schedule: ScheduleReportData) => {
    setEditingSchedule(schedule)

    // Pre-populate the form with data from the schedule
    setEditFormData({
                  ...
                  <div className="min-w-full">
                    ...
                    <div className="rounded-t-lg" style={{ backgroundColor: 'rgb(243 244 246/var(--tw-bg-opacity,1))' }}>
                      <div className="grid grid-cols-12 gap-3 px-4 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                        ...
                        <div
                          className="col-span-2 flex items-center gap-1 capitalize cursor-pointer group"
                          onClick={() => handleSort('pghReportScheduleId')}
                        >
                          Schedule ID
                          <span className="opacity-0 group-hover:opacity-100 transition-opacity">
                            {getHoverIcon('pghReportScheduleId')}
                          </span>
                          <span className="opacity-100">
                            {getSortIcon('pghReportScheduleId')}
                          </span>
                        </div>
                        <div
                          className="col-span-2 flex items-center gap-1 capitalize cursor-pointer group"
                        ...
                        <div
                          className="col-span-1 flex items-center gap-1 capitalize cursor-pointer group"
                        ...
                        sortedScheduledReportsData.map((report, index) => {
                          ...
                          return (
                            <div
                              ...
                              className={`grid grid-cols-12 gap-3 px-4 py-2 text-sm ${index === scheduleData.length - 1 ? '' : 'border-b border-gray-100 dark:border-gray-800'
                                } ${index % 2 === 0
                  ...
                  <div className="flex flex-wrap gap-2">
                    {daysOfWeek.map((day) => (
                      <button
                        ...
                        className={`px-2 py-1 text-sm rounded-md border transition-colors ${editFormData.selectedDays.includes(day)
                  ...
                  <div>
                    ...
                    <div className="flex">
                      <button
                        ...
                        className={`flex-1 px-3 py-2 text-sm border-l border-t border-b rounded-l-md transition-colors ${editFormData.amPm === 'AM'
                          ? 'bg-blue-600 text-white border-blue-600'
                          : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex-1 px-3 py-2 text-sm border-r border-t border-b rounded-r-md transition-colors ${editFormData.amPm === 'PM'
                          ? 'bg-blue-600 text-white border-blue-600'
                          : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                          }`}
                      >
